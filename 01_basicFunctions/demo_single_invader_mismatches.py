...
**mean reaction times for single invader mismatches**
...
meanSDrate = SDMMrates(mismatchPosition,toeholdLength,N,dGBP,dGp,dGBM,dGassoc,dGMM,kbm,c,mode)

print('mean reaction time: {:.1f} s (toehold length: {:.0f} mismatch position: {:.0f})'.format(1/meanSDrate,toeholdLength,mismatchPosition))
